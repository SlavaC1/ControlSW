...
template<> locale::id num_get<char, istreambuf_iterator<char, char_traits<char> > >::id = {12};
template<> locale::id num_get<char, const char*>::id = {13};

# ifndef _STLP_NO_WCHAR_T
template<> locale::id num_get<wchar_t, istreambuf_iterator<wchar_t, char_traits<wchar_t> > >::id = {31};
template<> locale::id num_get<wchar_t, const wchar_t*>::id = {32};
# endif

void num_get_dummy_id_inst_func() {
