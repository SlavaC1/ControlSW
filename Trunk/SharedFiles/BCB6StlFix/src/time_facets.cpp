...
template<> locale::id time_get<char, istreambuf_iterator<char, char_traits<char> > >::id = {16};
template<> locale::id time_get<char, const char*>::id = {17};
template<> locale::id time_put<char, ostreambuf_iterator<char, char_traits<char> > >::id = {18};
template<> locale::id time_put<char, char*>::id = {19};
  
# ifndef _STLP_NO_WCHAR_T
template<> locale::id time_get<wchar_t, istreambuf_iterator<wchar_t, char_traits<wchar_t> > >::id = {35};
template<> locale::id time_get<wchar_t, const wchar_t*>::id = {36};
template<> locale::id time_put<wchar_t, ostreambuf_iterator<wchar_t, char_traits<wchar_t> > >::id = {37};
template<> locale::id time_put<wchar_t, wchar_t*>::id = {38};
# endif

void time_facets_dummy_id_inst_func() {
