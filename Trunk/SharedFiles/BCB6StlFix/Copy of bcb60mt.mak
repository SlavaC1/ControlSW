...
# ---------------------------------------------------------------------------
#  Comment/Uncomment these as needed to match your environment
# ---------------------------------------------------------------------------
# Using 4NT
MKDIR=-md /s
RM=-rd /S
...
FLAGS_COMMON= -I.;..\stlport;$(BCB)\include;$(BCB)\include\windows -D_USE_OLD_RW_STL $(DPARAM) -jb -j1 -w -c -w-par -w-inl -tWM -w-stl
...
CXXFLAGS_DEBUG_static= $(FLAGS_COMMON_static) -x -xp -n$(DEBUG_OBJDIR_static)
CXXFLAGS_STLDEBUG_static= $(FLAGS_COMMON_static) -x -xp -n$(STLDEBUG_OBJDIR_static) -D_STLP_DEBUG

CXXFLAGS_RELEASE_dynamic= $(FLAGS_COMMON_dynamic) -O2 -n$(RELEASE_OBJDIR_dynamic)
CXXFLAGS_DEBUG_dynamic= $(FLAGS_COMMON_dynamic) -v -x -xp -n$(DEBUG_OBJDIR_dynamic)
CXXFLAGS_STLDEBUG_dynamic= $(FLAGS_COMMON_dynamic) -v -x -xp -n$(STLDEBUG_OBJDIR_dynamic) -D_STLP_DEBUG
...
all_dynamic :  $(ALL_DYNAMIC_LIBS) $(OUTDIR)$(PATH_SEP)$(RELEASE_NAME)i.lib $(OUTDIR)$(PATH_SEP)$(STLDEBUG_NAME)i.lib
...
### Create import libs here ###

$(OUTDIR)$(PATH_SEP)$(RELEASE_NAME)i.lib: $(OUTDIR)$(PATH_SEP)$(RELEASE_DYNLIB)
	$(IMPLIB) $(OUTDIR)$(PATH_SEP)$(RELEASE_NAME)i.lib $(OUTDIR)$(PATH_SEP)$(RELEASE_DYNLIB)

$(OUTDIR)$(PATH_SEP)$(STLDEBUG_NAME)i.lib: $(OUTDIR)$(PATH_SEP)$(STLDEBUG_DYNLIB)
	$(IMPLIB) $(OUTDIR)$(PATH_SEP)$(STLDEBUG_NAME)i.lib $(OUTDIR)$(PATH_SEP)$(STLDEBUG_DYNLIB)
