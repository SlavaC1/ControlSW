...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvDynControlEngineDBToolscxVGrid.pas $';
    Revision: '$Revision: 12806 $';
    Date: '$Date: 2010-06-12 19:27:30 +0200 (Sat, 12 Jun 2010) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
