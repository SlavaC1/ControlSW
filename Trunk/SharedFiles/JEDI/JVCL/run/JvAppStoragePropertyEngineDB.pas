...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvAppStoragePropertyEngineDB.pas $';
    Revision: '$Revision: 13088 $';
    Date: '$Date: 2011-07-10 14:10:33 +0200 (Sun, 10 Jul 2011) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
