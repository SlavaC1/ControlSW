...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDSADialogs.pas 13110 2011-09-07 19:43:33Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvDSADialogs.pas $';
    Revision: '$Revision: 13110 $';
    Date: '$Date: 2011-09-07 21:43:33 +0200 (Wed, 07 Sep 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
