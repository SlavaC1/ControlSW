...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvDBActionsEngineDatasetOdac.pas $';
    Revision: '$Revision: 12669 $';
    Date: '$Date: 2010-01-08 00:17:07 +0100 (Fri, 08 Jan 2010) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
