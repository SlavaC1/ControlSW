...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvPropertyStoreEditor.pas 13145 2011-11-02 21:15:19Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvPropertyStoreEditor.pas $';
    Revision: '$Revision: 13145 $';
    Date: '$Date: 2011-11-02 22:15:19 +0100 (Wed, 02 Nov 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
