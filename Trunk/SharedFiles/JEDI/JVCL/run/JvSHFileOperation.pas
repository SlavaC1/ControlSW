...
-----------------------------------------------------------------------------}
// $Id: JvSHFileOperation.pas 13138 2011-10-26 23:17:50Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvSHFileOperation.pas $';
