...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvClock.pas 13139 2011-10-28 19:59:40Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvClock.pas $';
    Revision: '$Revision: 13139 $';
    Date: '$Date: 2011-10-28 21:59:40 +0200 (Fri, 28 Oct 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
