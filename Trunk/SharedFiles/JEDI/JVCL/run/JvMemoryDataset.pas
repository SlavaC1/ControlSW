...
Revisions : 1st = 2004/09/19
            ...
            8th = 2007/06/20
-----------------------------------------------------------------------------}
// $Id: JvMemoryDataset.pas 13157 2011-11-06 13:11:27Z jfudickar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvMemoryDataset.pas $';
    Revision: '$Revision: 13157 $';
    Date: '$Date: 2011-11-06 14:11:27 +0100 (Sun, 06 Nov 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
