{ -----------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------- }
// $Id: JvJclUnitVersioningBrowser.pas 13104 2011-09-07 06:50:43Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvJclUnitVersioningBrowser.pas $';
    Revision: '$Revision: 13104 $';
    Date: '$Date: 2011-09-07 08:50:43 +0200 (Wed, 07 Sep 2011) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
