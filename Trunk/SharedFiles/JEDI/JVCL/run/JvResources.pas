...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvResources.pas 13154 2011-11-06 11:54:32Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvResources.pas $';
    Revision: '$Revision: 13154 $';
    Date: '$Date: 2011-11-06 12:54:32 +0100 (Sun, 06 Nov 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
