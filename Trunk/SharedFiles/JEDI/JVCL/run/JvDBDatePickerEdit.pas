...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBDatePickerEdit.pas 13135 2011-10-25 11:25:40Z ahuser $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvDBDatePickerEdit.pas $';
    Revision: '$Revision: 13135 $';
    Date: '$Date: 2011-10-25 13:25:40 +0200 (Tue, 25 Oct 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
