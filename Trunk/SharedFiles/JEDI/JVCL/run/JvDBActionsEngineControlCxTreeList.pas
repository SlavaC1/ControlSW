...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile:
    '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvDBActionsEngineControlCxTreeList.pas $';
    Revision: '$Revision: 12998 $';
    Date: '$Date: 2011-03-06 23:24:57 +0100 (Sun, 06 Mar 2011) $';
    LogPath: 'JVCL\run'
    );
  {$ENDIF UNITVERSIONING}
