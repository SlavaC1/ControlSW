...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: http://jvcl.svn.sourceforge.net/svnroot/jvcl/trunk/jvcl/run/JvControlActionsEngineCxPivotGrid.pas $';
    Revision: '$Revision: 13099 $';
    Date: '$Date: 2011-09-02 23:51:31 +0200 (Fri, 02 Sep 2011) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
