...
// (DO NOT EDIT: machine generated header) 'Pythonengine.pas' rev: 11.00
...
#pragma option push -b-
enum TPyMemberType { mtShort, mtInt, mtLong, mtFloat, mtDouble, mtString, mtObject, mtChar, mtByte, mtUByte, mtUShort, mtUInt, mtULong, mtStringInplace, mtObjectEx };
#pragma option pop

#pragma option push -b-
enum TPyMemberFlag { mfDefault, mfReadOnly, mfReadRestricted, mfRestricted };
#pragma option pop

typedef char *TPChar[16001];

typedef TPChar *PPChar;
...
typedef PPyObject __cdecl (*TPyCFunctionWithExtraArg)(void * ExtraArg, PPyObject self, PPyObject args);
...
typedef PPyObject __cdecl (*getiterfunc)(PPyObject ob1);

typedef PPyObject __cdecl (*iternextfunc)(PPyObject ob1);

typedef PPyObject __cdecl (*descrgetfunc)(PPyObject ob1, PPyObject ob2, PPyObject ob3);

typedef int __cdecl (*descrsetfunc)(PPyObject ob1, PPyObject ob2, PPyObject ob3);

typedef int __cdecl (*initproc)(PPyObject self, PPyObject args, PPyObject kwds);

typedef PPyObject __cdecl (*newfunc)(PPyTypeObject subtype, PPyObject args, PPyObject kwds);

typedef PPyObject __cdecl (*allocfunc)(PPyTypeObject self, int nitems);
...
typedef PPyObject __cdecl (*getter)(PPyObject obj, void * context);

typedef int __cdecl (*setter)(PPyObject obj, PPyObject value, void * context);
...
typedef PPyObject __cdecl (*wrapperfunc)(PPyObject self, PPyObject args, void * wrapped);
...
typedef _PyDateTime_BaseTZInfo *_PPyDateTime_BaseTZInfo;
...
typedef _PyDateTime_BaseTime *_PPyDateTime_BaseTime;
...
typedef _PyDateTime_BaseDateTime *_PPyDateTime_BaseDateTime;
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EDLLLoadError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EDLLLoadError(int Ident)/* overload */ : Sysutils::Exception(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EDLLLoadError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EDLLLoadError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EDLLLoadError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EDLLImportError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EDLLImportError(int Ident)/* overload */ : Sysutils::Exception(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EDLLImportError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EDLLImportError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EDLLImportError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPythonError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPythonError(int Ident)/* overload */ : Sysutils::Exception(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPythonError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPythonError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPythonError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : Sysutils::Exception(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyExecError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPythonError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyExecError(int Ident)/* overload */ : EPythonError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyExecError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPythonError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EPyExecError(const AnsiString Msg, int AHelpContext) : EPythonError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyExecError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPythonError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyExecError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPythonError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyException(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPythonError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyException(int Ident)/* overload */ : EPythonError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyException(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPythonError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EPyException(const AnsiString Msg, int AHelpContext) : EPythonError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyException(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPythonError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyException(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPythonError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyStandardError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyStandardError(int Ident)/* overload */ : EPyException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyStandardError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyStandardError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyStandardError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyArithmeticError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyArithmeticError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyArithmeticError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyArithmeticError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyArithmeticError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyLookupError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyLookupError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyLookupError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyLookupError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyLookupError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyAssertionError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyAssertionError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyAssertionError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyAssertionError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyAssertionError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyAttributeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyAttributeError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyAttributeError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyAttributeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyAttributeError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyEOFError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyEOFError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyEOFError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyEOFError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyEOFError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyFloatingPointError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyArithmeticError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyFloatingPointError(int Ident)/* overload */ : EPyArithmeticError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyFloatingPointError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyArithmeticError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyFloatingPointError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyArithmeticError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyFloatingPointError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyArithmeticError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyEnvironmentError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyEnvironmentError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyEnvironmentError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyEnvironmentError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyEnvironmentError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyIOError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyEnvironmentError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyIOError(int Ident)/* overload */ : EPyEnvironmentError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyIOError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyEnvironmentError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyIOError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyEnvironmentError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyIOError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyEnvironmentError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyOSError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyEnvironmentError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyOSError(int Ident)/* overload */ : EPyEnvironmentError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyOSError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyEnvironmentError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyOSError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyEnvironmentError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyOSError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyEnvironmentError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyImportError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyImportError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyImportError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyImportError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyImportError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyIndexError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyLookupError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyIndexError(int Ident)/* overload */ : EPyLookupError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyIndexError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyLookupError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyIndexError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyLookupError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyIndexError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyLookupError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyKeyError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyLookupError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyKeyError(int Ident)/* overload */ : EPyLookupError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyKeyError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyLookupError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EPyKeyError(const AnsiString Msg, int AHelpContext) : EPyLookupError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyKeyError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyLookupError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyKeyError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyLookupError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyKeyboardInterrupt(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyKeyboardInterrupt(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyKeyboardInterrupt(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyKeyboardInterrupt(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyKeyboardInterrupt(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyMemoryError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyMemoryError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyMemoryError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyMemoryError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyMemoryError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyNameError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyNameError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyNameError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyNameError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyNameError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyOverflowError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyArithmeticError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyOverflowError(int Ident)/* overload */ : EPyArithmeticError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyOverflowError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyArithmeticError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyOverflowError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyArithmeticError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyOverflowError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyArithmeticError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyRuntimeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyRuntimeError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyRuntimeError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyRuntimeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyRuntimeError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyNotImplementedError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyRuntimeError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyNotImplementedError(int Ident)/* overload */ : EPyRuntimeError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyNotImplementedError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyRuntimeError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyNotImplementedError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyRuntimeError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyNotImplementedError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyRuntimeError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPySyntaxError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPySyntaxError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPySyntaxError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPySyntaxError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPySyntaxError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyIndentationError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPySyntaxError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyIndentationError(int Ident)/* overload */ : EPySyntaxError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyIndentationError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPySyntaxError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyIndentationError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPySyntaxError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyIndentationError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPySyntaxError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyTabError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyIndentationError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyTabError(int Ident)/* overload */ : EPyIndentationError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyTabError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyIndentationError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyTabError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyIndentationError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyTabError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyIndentationError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPySystemError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPySystemError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPySystemError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPySystemError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPySystemError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPySystemExit(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPySystemExit(int Ident)/* overload */ : EPyException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPySystemExit(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EPySystemExit(const AnsiString Msg, int AHelpContext) : EPyException(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPySystemExit(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPySystemExit(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyTypeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyTypeError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyTypeError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyTypeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyTypeError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyUnboundLocalError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyNameError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyUnboundLocalError(int Ident)/* overload */ : EPyNameError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyUnboundLocalError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyNameError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyUnboundLocalError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyNameError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyUnboundLocalError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyNameError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyValueError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyValueError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyValueError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyValueError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyValueError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyUnicodeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyValueError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyUnicodeError(int Ident)/* overload */ : EPyValueError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyUnicodeError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyValueError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyUnicodeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyValueError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyUnicodeError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyValueError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall UnicodeEncodeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyUnicodeError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall UnicodeEncodeError(int Ident)/* overload */ : EPyUnicodeError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall UnicodeEncodeError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyUnicodeError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall UnicodeEncodeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyUnicodeError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall UnicodeEncodeError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyUnicodeError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall UnicodeDecodeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyUnicodeError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall UnicodeDecodeError(int Ident)/* overload */ : EPyUnicodeError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall UnicodeDecodeError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyUnicodeError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall UnicodeDecodeError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyUnicodeError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall UnicodeDecodeError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyUnicodeError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall UnicodeTranslateError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyUnicodeError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall UnicodeTranslateError(int Ident)/* overload */ : EPyUnicodeError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall UnicodeTranslateError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyUnicodeError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall UnicodeTranslateError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyUnicodeError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall UnicodeTranslateError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyUnicodeError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyZeroDivisionError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyArithmeticError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyZeroDivisionError(int Ident)/* overload */ : EPyArithmeticError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyZeroDivisionError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyArithmeticError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyZeroDivisionError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyArithmeticError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyZeroDivisionError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyArithmeticError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyStopIteration(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyStopIteration(int Ident)/* overload */ : EPyException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyStopIteration(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyStopIteration(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyStopIteration(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyWarning(int Ident)/* overload */ : EPyException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyWarning(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EPyWarning(const AnsiString Msg, int AHelpContext) : EPyException(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EPyWarning(int Ident, int AHelpContext)/* overload */ : EPyException(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyWarning(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyUserWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyWarning(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyUserWarning(int Ident)/* overload */ : EPyWarning(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyUserWarning(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyWarning(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EPyUserWarning(const AnsiString Msg, int AHelpContext) : EPyWarning(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyUserWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyWarning(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyUserWarning(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyWarning(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyDeprecationWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyWarning(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyDeprecationWarning(int Ident)/* overload */ : EPyWarning(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyDeprecationWarning(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyWarning(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyDeprecationWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyWarning(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyDeprecationWarning(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyWarning(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall PendingDeprecationWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyWarning(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall PendingDeprecationWarning(int Ident)/* overload */ : EPyWarning(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall PendingDeprecationWarning(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyWarning(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall PendingDeprecationWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyWarning(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall PendingDeprecationWarning(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyWarning(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall FutureWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyWarning(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall FutureWarning(int Ident)/* overload */ : EPyWarning(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall FutureWarning(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyWarning(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall FutureWarning(const AnsiString Msg, int AHelpContext) : EPyWarning(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall FutureWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyWarning(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall FutureWarning(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyWarning(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPySyntaxWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyWarning(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPySyntaxWarning(int Ident)/* overload */ : EPyWarning(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPySyntaxWarning(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyWarning(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPySyntaxWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyWarning(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPySyntaxWarning(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyWarning(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyOverflowWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyWarning(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyOverflowWarning(int Ident)/* overload */ : EPyWarning(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyOverflowWarning(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyWarning(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyOverflowWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyWarning(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyOverflowWarning(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyWarning(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyRuntimeWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyWarning(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyRuntimeWarning(int Ident)/* overload */ : EPyWarning(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyRuntimeWarning(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyWarning(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyRuntimeWarning(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyWarning(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyRuntimeWarning(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyWarning(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyReferenceError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyStandardError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyReferenceError(int Ident)/* overload */ : EPyStandardError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyReferenceError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyStandardError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyReferenceError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyStandardError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyReferenceError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyStandardError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EPyWindowsError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size) : EPyOSError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EPyWindowsError(int Ident)/* overload */ : EPyOSError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EPyWindowsError(int Ident, System::TVarRec const * Args, const int Args_Size)/* overload */ : EPyOSError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EPyWindowsError(const AnsiString Msg, int AHelpContext) : EPyOSError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EPyWindowsError(const AnsiString Msg, System::TVarRec const * Args, const int Args_Size, int AHelpContext) : EPyOSError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EPyWindowsError(System::PResStringRec ResStringRec, System::TVarRec const * Args, const int Args_Size, int AHelpContext)/* overload */ : EPyOSError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	void __cdecl (*PyObject_Free)(PPyObject ob);
	...
	PPyObject __cdecl (*PyObject_GenericGetAttr)(PPyObject obj, PPyObject name);
	int __cdecl (*PyObject_GenericSetAttr)(PPyObject obj, PPyObject name, PPyObject value);
	...
	PPyObject __cdecl (*PyType_GenericAlloc)(PPyTypeObject atype, int nitems);
	PPyObject __cdecl (*PyType_GenericNew)(PPyTypeObject atype, PPyObject args, PPyObject kwds);
	int __cdecl (*PyType_Ready)(PPyTypeObject atype);
	PPyObject __cdecl (*PyUnicode_FromWideChar)(const WideChar * w, int size);
	int __cdecl (*PyUnicode_AsWideChar)(PPyObject unicode, WideChar * w, int size);
	...
	int __cdecl PyArg_Parse(PPyObject args, char * format, void * * argp, const int argp_Size);
	int __cdecl PyArg_ParseTuple(PPyObject args, char * format, void * * argp, const int argp_Size);
	PPyObject __cdecl Py_BuildValue(char * format, System::TVarRec * args, const int args_Size);
...
private:
	...
	bool FIORedirected;
	System::TObject* FIOPythonModule;
...
public:
	...
	void __fastcall ExecStringUseDict(const AnsiString command, PPyObject DictToUse);
	...
	Variant __fastcall EvalFunction(PPyObject pyfunc, System::TVarRec * args, const int args_Size);
	Variant __fastcall EvalFunctionNoArgs(PPyObject pyfunc);
	AnsiString __fastcall EvalStringAsStr(const AnsiString command);
	AnsiString __fastcall EvalStringAsStrUseDict(const AnsiString command, PPyObject DictToUse);
	...
	PPyObject __fastcall MakePyTuple(PPyObject const * objects, const int objects_Size);
	PPyObject __fastcall MakePyList(PPyObject const * objects, const int objects_Size);
	PPyObject __fastcall ArrayToPyTuple(System::TVarRec * items, const int items_Size);
	PPyObject __fastcall ArrayToPyList(System::TVarRec * items, const int items_Size);
	PPyObject __fastcall ArrayToPyDict(System::TVarRec * items, const int items_Size);
	...
	void __fastcall ClearModuleDictionary(void);
...
typedef TMethodArray *PMethodArray;
...
public:
	...
	virtual void __fastcall Initialize(void);
	virtual void __fastcall Finalize(void);
	PPyMethodDef __fastcall AddMethod(char * MethodName, PyCFunction Method, char * DocString);
	PPyMethodDef __fastcall AddDelphiMethod(char * MethodName, TDelphiMethod DelphiMethod, char * DocString);
	PPyMethodDef __fastcall AddMethodWithExtraArg(char * MethodName, TPyCFunctionWithExtraArg MethodWithExtraArg, void * ExtraArg, char * DocString);
	void __fastcall ClearMethods(void);
...
typedef PyMemberDef TMemberArray[16001];

typedef TMemberArray *PMemberArray;

class DELPHICLASS TMembersContainer;
class PASCALIMPLEMENTATION TMembersContainer : public TMethodsContainer 
{
	typedef TMethodsContainer inherited;
	
protected:
	virtual int __fastcall GetMembersStartOffset(void);
	
private:
	int FMemberCount;
	int FAllocatedMemberCount;
	PyMemberDef *FMembers;
	void __fastcall AllocMembers(void);
	void __fastcall FreeMembers(void);
	void __fastcall ReallocMembers(void);
	PPyMemberDef __fastcall GetMembers(int idx);
	
public:
	__fastcall virtual TMembersContainer(Classes::TComponent* AOwner);
	__fastcall virtual ~TMembersContainer(void);
	void __fastcall AddMember(char * MemberName, TPyMemberType MemberType, int MemberOffset, TPyMemberFlag MemberFlags, char * MemberDoc);
	void __fastcall ClearMembers(void);
	virtual void __fastcall Finalize(void);
	__property int MemberCount = {read=FMemberCount, nodefault};
	__property PPyMemberDef Members[int idx] = {read=GetMembers};
	__property PPyMemberDef MembersData = {read=FMembers};
};


typedef PyGetSetDef TGetSetArray[16001];

typedef TGetSetArray *PGetSetArray;

class DELPHICLASS TGetSetContainer;
class PASCALIMPLEMENTATION TGetSetContainer : public TMembersContainer 
{
	typedef TMembersContainer inherited;
	
private:
	int FGetSetCount;
	int FAllocatedGetSetCount;
	PyGetSetDef *FGetSets;
	void __fastcall AllocGetSets(void);
	void __fastcall FreeGetSets(void);
	void __fastcall ReallocGetSets(void);
	PPyGetSetDef __fastcall GetGetSet(int idx);
	
public:
	__fastcall virtual TGetSetContainer(Classes::TComponent* AOwner);
	__fastcall virtual ~TGetSetContainer(void);
	void __fastcall AddGetSet(char * AName, getter AGet, setter ASet, char * ADoc, void * AClosure);
	void __fastcall ClearGetSets(void);
	virtual void __fastcall Finalize(void);
	__property int GetSetCount = {read=FGetSetCount, nodefault};
	__property PPyGetSetDef GetSet[int idx] = {read=GetGetSet};
	__property PPyGetSetDef GetSetData = {read=FGetSets};
};
...
public:
	...
	void __fastcall RaiseErrorFmt(const AnsiString error, const AnsiString format, System::TVarRec * Args, const int Args_Size);
...
#pragma option push -b-
enum PythonEngine__76 { bsPrint, bsGetAttr, bsSetAttr, bsRepr, bsCompare, bsHash, bsStr, bsGetAttrO, bsSetAttrO, bsCall, bsTraverse, bsClear, bsRichCompare, bsIter, bsIterNext };
#pragma option pop

typedef Set<PythonEngine__76, bsPrint, bsIterNext>  TBasicServices;

#pragma option push -b-
enum PythonEngine__86 { nsAdd, nsSubstract, nsMultiply, nsDivide, nsRemainder, nsDivmod, nsPower, nsNegative, nsPositive, nsAbsolute, nsNonZero, nsInvert, nsLShift, nsRShift, nsAnd, nsXor, nsOr, nsCoerce, nsInt, nsLong, nsFloat, nsOct, nsHex, nsFloorDivide, nsTrueDivide };
#pragma option pop

typedef Set<PythonEngine__86, nsAdd, nsTrueDivide>  TNumberServices;

#pragma option push -b-
enum PythonEngine__07 { ssLength, ssConcat, ssRepeat, ssItem, ssSlice, ssAssItem, ssAssSlice, ssContains, ssInplaceConcat, ssInplaceRepeat };
#pragma option pop

typedef Set<PythonEngine__07, ssLength, ssInplaceRepeat>  TSequenceServices;

#pragma option push -b-
enum PythonEngine__17 { msLength, msSubscript, msAssSubscript };
#pragma option pop

typedef Set<PythonEngine__17, msLength, msAssSubscript>  TMappingServices;

#pragma option push -b-
enum PythonEngine__96 { nsInplaceAdd, nsInplaceSubtract, nsInplaceMultiply, nsInplaceDivide, nsInplaceRemainder, nsInplacePower, nsInplaceLShift, nsInplaceRShift, nsInplaceAnd, nsInplaceXor, nsInplaceOr, nsInplaceFloorDivide, nsInplaceTrueDivide };
#pragma option pop

typedef Set<PythonEngine__96, nsInplaceAdd, nsInplaceTrueDivide>  TInplaceNumberServices;
...
class PASCALIMPLEMENTATION TPythonType : public TGetSetContainer 
{
	typedef TGetSetContainer inherited;
...
protected:
	...
	int FDeleteHits;
	TPFlags FTypeFlags;
	PyObject *FCreateFunc;
	PyMethodDef FCreateFuncDef;
	virtual void __fastcall Notification(Classes::TComponent* AComponent, Classes::TOperation Operation);
	...
	int __cdecl InitSubtype(PPyObject pSelf, PPyObject args, PPyObject kwds);
	PPyObject __cdecl NewSubtypeInst(PPyTypeObject aType, PPyObject args, PPyObject kwds);
	PPyObject __cdecl AllocSubtypeInst(PPyTypeObject pSelf, int nitems);
...
private:
	int __fastcall Get_ob_refcnt(void);
	PPyTypeObject __fastcall Get_ob_type(void);
	void __fastcall Set_ob_refcnt(const int Value);
	void __fastcall Set_ob_type(const PPyTypeObject Value);
...
public:
	...
	__property int ob_refcnt = {read=Get_ob_refcnt, write=Set_ob_refcnt, nodefault};
	__property PPyTypeObject ob_type = {read=Get_ob_type, write=Set_ob_type};
	...
	virtual int __fastcall Init(PPyObject args, PPyObject kwds);
	...
	/* virtual class method */ virtual void __fastcall RegisterMembers(TMetaClass* vmt, TPythonType* PythonType);
	/* virtual class method */ virtual void __fastcall RegisterGetSets(TMetaClass* vmt, TPythonType* PythonType);
};
...
static const Shortint PYT_MEMBER_BUFFER_INCREASE = 0xa;
static const Shortint PYT_GETSET_BUFFER_INCREASE = 0xa;
...
#define TPFLAGS_DEFAULT (Set<TPFlag, tpfHaveGetCharBuffer, tpfHaveGC> () << tpfHaveGetCharBuffer << tpfHaveSequenceIn << tpfHaveInplaceOps << tpfHaveRichCompare << tpfHaveWeakRefs << tpfHaveIter << tpfHaveClass )
...
static const Shortint T_SHORT = 0x0;
static const Shortint T_INT = 0x1;
static const Shortint T_LONG = 0x2;
static const Shortint T_FLOAT = 0x3;
static const Shortint T_DOUBLE = 0x4;
static const Shortint T_STRING = 0x5;
static const Shortint T_OBJECT = 0x6;
static const Shortint T_CHAR = 0x7;
static const Shortint T_BYTE = 0x8;
static const Shortint T_UBYTE = 0x9;
static const Shortint T_USHORT = 0xa;
static const Shortint T_UINT = 0xb;
static const Shortint T_ULONG = 0xc;
static const Shortint T_STRING_INPLACE = 0xd;
static const Shortint T_OBJECT_EX = 0x10;
static const Shortint READONLY = 0x1;
static const Shortint RO = 0x1;
static const Shortint READ_RESTRICTED = 0x2;
static const Shortint RESTRICTED = 0x2;
static const short ErrInit = -300;
...
static const TDatetimeConversionMode DEFAULT_DATETIME_CONVERSION_MODE = (TDatetimeConversionMode)(0);
...
extern PACKAGE void __cdecl FreeSubtypeInst(PPyObject ob);
