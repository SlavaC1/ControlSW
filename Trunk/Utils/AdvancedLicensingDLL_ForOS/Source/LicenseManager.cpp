...
std::string __stdcall CLicenseManager::DecryptDatabaseFile(std::string FilePath)
{
...
unsigned int __stdcall CLicenseManager::ReadFileIntoBuffer(std::string FilePath)
{
...
void __stdcall CLicenseManager::ParseProperties(XMLElement* PropertiesNode, const std::string &PackageName)
{
	if(PropertiesNode)
	{
...
void __stdcall CLicenseManager::ParseMaterialsList(XMLElement* MaterialsNode, TLicensedMaterialsList &MaterialsList, const std::string &PackageName)
{
	if(MaterialsNode)
	{
...
void __stdcall CLicenseManager::GetLicensedMaterials(TMaterialsList *MaterialsList)
{
