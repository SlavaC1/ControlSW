...
BYTE* CLogic::ReadTag(DWORD v_dwTagID, BYTE* v_bResult, bool v_fReadBlockData, int* v_iDataSize, int v_iBeginByte, int v_iReadLength, bool v_iIsWrite)
{
	...
	*v_iDataSize = 0;
	...
	bLockBit = ReadConfig(bRdLockMap);
	/*
...
bool CLogic::Lock(int v_iFirstPage, int v_iLastPage)
{
	...
	{	
		for (i = v_iFirstPage; i <= v_iLastPage; i++)
		{
			if ( i <= 5 && i >= 4 )
			{
				pPageData[2] |= 0x80; 
		...
		if ( m_pHitag->HT1_WritePage(0x00, 1, pPageData) == ESERIELL )
...
bool CLogic::GetLockBitStatus(BYTE v_cConfigByte)
{
	...
	v_cConfigByte >>= 1;
	v_cConfigByte <<= 1;
	bLockBit = (bool)(pTemp - v_cConfigByte);
	return bLockBit;
}
...
// Parameters......: bool v_fReadBlockData, bool v_bLockBit, bool* v_bLockMap, int v_iPageNum
// Return..........: 
/////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////
unsigned __int64 CLogic::GetUID(int v_iPosition)
{
