 ...
 *   PROCEDURES     : 
 *===========================================================================*/
#define DEFINE_MSG_EXTERN_VARIABLES
...
// Constants
// =========
#define EDEN_PROTOCOL_MAX_MSG_LENGTH	75
...
EDEN_PROTOCOL_STATUS EdenProtocolSend(BYTE *Data, WORD DataLength, BYTE DestId , BYTE SourceId ,BYTE Transaction, BOOL Reply, BYTE Protocol)
{
	...
	//No point in sending a message to EDEN_ID if the target is not responding
  	if ((EDEN_ID == DestId) && (TargetIsUnresponsive))
