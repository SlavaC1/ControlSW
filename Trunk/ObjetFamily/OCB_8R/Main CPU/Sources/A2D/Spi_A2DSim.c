...
/*	case ANALOG_IN_6 + SIM_OHDB_OFFSET:	
	...
	case ANALOG_IN_1+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_1_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_2+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_2_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_3+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_3_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_4+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_4_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_5+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_5_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_6+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_6_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_7+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_7_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_8+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_8_ADD_OHDB,&retVal);
		break;
	case ANALOG_IN_9+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_9_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_10+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_10_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_11+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_11_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_12+ SIM_OHDB_OFFSET:
		EXTMem_ReadAnalog12(ANALOG_IN_12_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_22 + SIM_OHDB_OFFSET: //pre heater = EXTERNAL_LIQUID_TEMP
	...
	case ANALOG_IN_15+SIM_OHDB_OFFSET: //M3_THERMISTOR_LEVEL_SENSOR
		...
		break;
	case ANALOG_IN_16+SIM_OHDB_OFFSET: //M4_THERMISTOR_LEVEL_SENSOR
		EXTMem_ReadAnalog12(ANALOG_IN_16_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_17 + SIM_OHDB_OFFSET: //M5_THERMISTOR_LEVEL_SENSOR	
		EXTMem_ReadAnalog12(ANALOG_IN_17_ADD_OHDB, &retVal);
		break;
	case ANALOG_IN_18 + SIM_OHDB_OFFSET: //M6_THERMISTOR_LEVEL_SENSOR
		EXTMem_ReadAnalog12(ANALOG_IN_18_ADD_OHDB, &retVal);	
		break;
	case ANALOG_IN_19 + SIM_OHDB_OFFSET: //M7_THERMISTOR_LEVEL_SENSOR
		EXTMem_ReadAnalog12(ANALOG_IN_19_ADD_OHDB, &retVal);	
		break;
	case ANALOG_IN_20 + SIM_OHDB_OFFSET:	//SUPPORT_THERMISTOR_LEVEL_SENSOR
		EXTMem_ReadAnalog12(ANALOG_IN_20_ADD_OHDB, &retVal);	
		break;
	...
	*/
	...
	case ANALOG_IN_24+SIM_OHDB_OFFSET:	//M1_M2_THERMISTOR_LEVEL_SENSOR
	   ...
	   break;
	case ANALOG_IN_26 + SIM_OHDB_OFFSET:	
		EXTMem_ReadAnalog12(ANALOG_IN_26_ADD_OHDB, &retVal);	
		break;
	case ANALOG_IN_27 + SIM_OHDB_OFFSET:	
		EXTMem_ReadAnalog12(ANALOG_IN_27_ADD_OHDB, &retVal);	
		break;
	case ANALOG_IN_28 + SIM_OHDB_OFFSET:	
		EXTMem_ReadAnalog12(ANALOG_IN_28_ADD_OHDB, &retVal);	
		break;
	case ANALOG_IN_29 + SIM_OHDB_OFFSET:	
		EXTMem_ReadAnalog12(ANALOG_IN_29_ADD_OHDB, &retVal);	
		break;
	   }	//end switch case
