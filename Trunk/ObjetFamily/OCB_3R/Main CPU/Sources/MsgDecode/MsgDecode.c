...
#ifdef OBJET_MACHINE
  SwapUnsignedLongArray((unsigned long*)&Msg.ModelTank1Weight,(unsigned long*)&Msg.ModelTank1Weight,10); // 10 tanks including WL and WR
#else
...
void GetUVLampsValueExTask(BYTE Arg)
{
  ...
  Msg.ValueINT = UVLampsGetValueINT();
  SwapUnsignedShort(&(Msg.ValueINT));

  Msg.ValueEXT = UVLampsGetValueEXT();
  SwapUnsignedShort(&(Msg.ValueEXT));

  Msg.ValueINT_Max = UVLampsGetValueINT_Max();
  SwapUnsignedShort(&(Msg.ValueINT_Max));

  Msg.ValueEXT_Max = UVLampsGetValueEXT_Max();
  SwapUnsignedShort(&(Msg.ValueEXT_Max));

  Msg.UVReadingMaxDeltaINT = UVLampsGetUVReadingMaxDeltaINT();
  SwapUnsignedShort(&(Msg.UVReadingMaxDeltaINT));
...
void GetSWVersionTask(BYTE Arg)
{
  ...
  Msg.MSC1HardwareVersion = I2CA2D_GetReading(LAST_BYTE, /*MSCCardLookUpTable[FIRSTMSCCARD]*/ FIRSTMSCCARD )& 0x01;//EladH, I2C Version
