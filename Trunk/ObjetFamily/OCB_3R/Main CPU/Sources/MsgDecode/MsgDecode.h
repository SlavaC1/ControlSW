...
#define I2C_STATUS_MSG                          0xF8 //EladH
...
typedef struct {		
	...
	BYTE MSC1HardwareVersion; //EladH added
	BYTE MSC1FirmwareVersion; //EladH added
	BYTE MSC2HardwareVersion; //EladH added
	BYTE MSC2FirmwareVersion; //EladH added
