...
#define EXTERNAL_LIQUID_TEMP  ANALOG_IN_20
#endif
...
#else
#define MODEL_BLOCK_HEAD_1_HEATER				8
#define MODEL_BLOCK_HEAD_2_HEATER				9
#define SUPPORT_BLOCK_HEAD_1_HEATER				10
#define SUPPORT_BLOCK_HEAD_2_HEATER				11
#define EXTERNAL_LIQUID_HEATER          		12
#endif
