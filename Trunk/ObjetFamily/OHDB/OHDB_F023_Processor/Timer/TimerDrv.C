 ...
 *
 *
 *  DESCRIPTION : Initialization of timer 4.                                        
 *
 ****************************************************************************/
void Timer_4_Init()
{
...
// select timer 4 as a 16 bit timer (mode 1) generated by the system clock
// -----------------------------------------------------------------------
  T4CON &= 0xFD;
  T4CON |= 0x01;
...
void Timer_4_ISR (void) interrupt 16 using 1
{
  ...
  // Clear timer 4 overflow flag
	T4CON &= 0x7f;

  MaterialCoolingFansControl(); 
