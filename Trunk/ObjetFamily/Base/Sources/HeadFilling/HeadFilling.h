...
// Following not implemented in OCB:
...
#ifdef OBJET_MACHINE_KESHET
   //This procedure is the callback for Set Thermistors Operation Mode
   static void SetThermistorsOpModeAckResponse(int TransactionId, PVOID Data,
                                               unsigned DataLength, TGenericCockie Cockie);
#endif /* OBJET_MACHINE_KESHET */
