...
#pragma warn -8057 // Disble warning Number 8057 "Never use parameter"
...
QString COCBProtocolClient::ConvertMessageToString(int MessageID)
{
   ...
   switch(MessageID)
      ...
      case OCB_LIQUID_TANK_STATUS_CHANGED     : MessageString = "LIQUID_TANK_STATUS_CHANGED";break;
      case OCB_LIQUID_TANK_WEIGHT             : MessageString = "LIQUID_TANK_WEIGHT";break;
	  ...
	  case OCB_GET_SAFETY_SYSTEM_STATUS_MSG  : MessageString = "Get Safety System Status";break;
	  case OCB_SEND_SAFETY_SYSTEM_STATUS_MSG : MessageString = "Send Safety System Status";break;
