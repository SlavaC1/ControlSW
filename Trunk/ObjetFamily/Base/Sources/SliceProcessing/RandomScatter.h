...
class CRandomScatter : public CScatterGenerator {
  ...
  public:
	...
	//int CalcNumOfPasses(int SliceHeight,int SliceSizeType,int SliceYOffset,int s_HeadPrintWidth,int ScatterPlusEvenOdd,int CoveredHeight);
	//int CalcYScatterOffset(int SliceHeight,int SliceSizeType,int SliceYOffset,int s_HeadPrintWidth, int ScatterPlusInterlace,int NoOfPasses);
