...
class CRollerBase : public CQComponent{
 ...
 protected:
    ...
    void UpdateBumperImpactCounter();             
  public:
    // Constructor
    ...
    DEFINE_METHOD(CRollerBase,TQErrCode,ResetBumperImpactCounter);
    ...
    DEFINE_METHOD(CRollerBase,int,GetBumperImpactCounter);
	virtual void Cancel(void) {}
	int  m_OrgRollerSpeed;
