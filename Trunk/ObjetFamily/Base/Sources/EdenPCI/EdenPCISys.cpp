...
#ifndef KERNEL_64BIT
	#error DataPCI: The PCI driver Kernel Plugin for Objet family of machines must be compiled with KERNEL_64BIT
#endif
...
void EdenPCI_FIFOSetReadMode(int ReadMode)
{
	...
	DWORD dwStatus = EdenPCI_WriteDWORD(AD_PCI_BAR2, PCI_WRITE_CTR_REG, ReadMode);
...
void EdenPCISystem_INTREnable(INTR_TYPE intType)
{
	...
	DWORD dwStatus = EdenPCI_WriteDWORD(AD_PCI_BAR2, PCI_LCL_INT_CTR_REG, val);
