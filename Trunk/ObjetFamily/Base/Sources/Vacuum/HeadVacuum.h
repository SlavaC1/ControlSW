...
#include "Vacuum.h"
#include "GlidingAverageWithThresholds.h"

const bool VACUUM_STATUS_OK = false;
const bool VACUUM_STATUS_WRONG = true;
...
class CHeadVacuumBase : public CQComponent {
  private:
	...
	GlidingAverageWithThresholds <float>m_GlidingAverageWithThresholds;
    static CLinearInterpolator <float> m_A2DToVacuumVoltage;
    float m_VacuumVoltage;
