...
CHitag::CHitag()
{
   memset(ht1SndBuf, 0, sizeof(ht1SndBuf));
   memset(ht1RcvBuf, 0, sizeof(ht1RcvBuf));;
   memset(ht2SndBuf, 0, sizeof(ht2SndBuf));
   memset(ht2RcvBuf, 0, sizeof(ht2RcvBuf));
   memset(htkiSndBuf, 0, sizeof(htkiSndBuf));
   memset(htkiRcvBuf, 0, sizeof(htkiRcvBuf));

   memset(htrSndBuf, 0, sizeof(htrSndBuf));
   memset(htrRcvBuf, 0, sizeof(htrRcvBuf));
   memset(htsSndBuf, 0, sizeof(htsSndBuf));
   memset(htsRcvBuf, 0, sizeof(htsRcvBuf));
   memset(htvSndBuf, 0, sizeof(htvSndBuf));
   memset(htvRcvBuf, 0, sizeof(htvRcvBuf));
