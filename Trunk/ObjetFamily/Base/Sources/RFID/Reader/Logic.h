...
public:
	...
	int GetTagsCountValue()const;//returns value of m_iTagsCount: number of read tags
	unsigned __int64 GetUID(int v_iPosition)const;//returns the UID of a tag in a certain position


	int GetCurrentError()const;//Returns current error number
