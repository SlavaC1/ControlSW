...
__published:	// IDE-managed Components
  ...
  TMenuItem *N3;
	...
	TMenuItem *ZCalibration1;
//    TMenuItem *FactoryShutdownWizardItem; // deprecated
	TMenuItem *OpenTrayPointsWizardAction1;
	TAction *RunAutomationScriptAction;
	TMenuItem *Fans1;
	TAction *OpenFansSpeedAction;
	...
	void __fastcall TrayRemovalPosition1Click(TObject *Sender);
	void __fastcall GotoTrayLowerPosition1Click(TObject *Sender);
	void __fastcall Wipe2Click(TObject *Sender);
	void __fastcall ZCalibration1Click(TObject *Sender);
	void __fastcall RunAutomationScriptActionExecute(TObject *Sender);
    void __fastcall UVCalibrationGNR2Click(TObject *Sender);
//    void __fastcall FactoryShutdownWizardItemClick(TObject *Sender); // deprecated
	void __fastcall OpenFansSpeedActionExecute(TObject *Sender);
	void __fastcall PFF1Click(TObject *Sender);
...
private:	// User declarations
  ...
  //==== Automation Related prototypes =====
  //creates a file with general info that assists QA's automated testing
  void CreateAutomatedTestingSupportFile();
  //creates more shortcuts available in case we're in Automation Mode
  void SetupDynamicShortcutsForAutomation();
...
public:		// User declarations
  ...
  void SetFormLocationVisible(TForm* form, int marginX=30, int marginY=30);
...
virtual void __fastcall Dispatch(void *Message)
{
  ...
  //MESSAGE_HANDLER(WM_POWERBROADCAST, TMessage, handlePowerStatus);
  else
