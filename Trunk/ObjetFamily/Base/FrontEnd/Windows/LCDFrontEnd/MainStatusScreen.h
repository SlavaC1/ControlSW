...
__published:	// IDE-managed Components
        ...
        TTimer *M1DrainTimer;
        TTimer *S1DrainTimer;
		TEnhancedLabel *CabinetAFrame;
		TEnhancedLabel *CabinetBFrame;
		TLabel *CabinetALabel;
		TLabel *CabinetBLabel;
...
private:	// User declarations
  ...
  int        m_TankRectHeightArray      [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
  int        m_CurrentActiveTankArray   [NUMBER_OF_CHAMBERS_INCLUDING_WASTE];
  TTankIndex m_ActiveTankArray          [NUMBER_OF_CHAMBERS_INCLUDING_WASTE];

  bool    m_TankStatusArray         [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
  bool    m_TankVisibleArray        [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
  TLabel* m_ResinTypeLabelArray     [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
  TLabel* m_ResinNameLabelArray     [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
  TImage* m_DrainImageArray         [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
  TImage* m_TankEnableArray         [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
...
public:		// User declarations
  TLabel*              m_ResinWeightLabelArray[TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
  TThreeLayersGraphic* m_TankGraphicsArray    [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
