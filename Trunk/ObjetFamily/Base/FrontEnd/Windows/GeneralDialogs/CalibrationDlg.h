...
private:	// User declarations
  ...
  // Need to remember actual tank indexes because tanks are skipped in the combo (dual waste)
  int m_ActualTankIndex[TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
