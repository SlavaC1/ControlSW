...
If the problem persists, contact your Stratasys provider.";
...
int TTankIDNotice::OpenDialog(int DialogType /*, int Cartridge*/)
{
  ...
  TagIDValueLabel->Caption = m_BackEndInterface->GetContainerRFTagID(m_Cartridge).c_str();
