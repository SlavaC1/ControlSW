  ...
  public:
	...
	void UpdateUVLampsCalibration(CUVLampsCalibrationWizardPage *Page)
	{
		...
		if( Page->DuringLampStab ) {
			...
			m_UVLampsCalibrationWizardFrame->LampStabPanel->Font->Color = clGreen;
			...
			m_UVLampsCalibrationWizardFrame->LampStabPanel->Font->Color = clBlack;
		...
		if( Page->DuringMeasureUV ) {
			...
			m_UVLampsCalibrationWizardFrame->MeasureUVPanel->Font->Color = clGreen;
			...
			m_UVLampsCalibrationWizardFrame->MeasureUVPanel->Font->Color = clBlack;
