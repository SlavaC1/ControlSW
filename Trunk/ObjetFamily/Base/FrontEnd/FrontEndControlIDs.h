...
#define CASE_MESSAGE_ALL_TANKS(_base_) \
	 ...
	 case _base_##_MODEL_TANK7:\
	 case _base_##_MODEL_TANK8:\
	 case _base_##_MODEL_TANK9:\
	 case _base_##_MODEL_TANK10:\
	 case _base_##_MODEL_TANK11:\
	 case _base_##_MODEL_TANK12:\
	 case _base_##_MODEL_TANK13:\
	 case _base_##_MODEL_TANK14:\
	 case _base_##_SUPPORT_TANK1:\
	 case _base_##_SUPPORT_TANK2:

  #define CASE_MESSAGE_ALL_TANKS_INCLUDING_WASTE(_base_) \
	 case _base_##_MODEL_TANK1:\
	 case _base_##_MODEL_TANK2:\
	 case _base_##_MODEL_TANK3:\
	 case _base_##_MODEL_TANK4:\
	 ...
	 case _base_##_SUPPORT_TANK1:\
	 case _base_##_SUPPORT_TANK2:\
	 case _base_##_WASTE_TANK_LEFT:\
	 case _base_##_WASTE_TANK_RIGHT:
...
#define DEFINE_FE_TANK_SET(_start_, _base_) \
   ...
   const int _base_##_MODEL_TANK7     = _base_##_BASE + TYPE_TANK_MODEL7;\
   const int _base_##_MODEL_TANK8     = _base_##_BASE + TYPE_TANK_MODEL8;\
   const int _base_##_MODEL_TANK9     = _base_##_BASE + TYPE_TANK_MODEL9;\
   const int _base_##_MODEL_TANK10     = _base_##_BASE + TYPE_TANK_MODEL10;\
   const int _base_##_MODEL_TANK11     = _base_##_BASE + TYPE_TANK_MODEL11;\
   const int _base_##_MODEL_TANK12     = _base_##_BASE + TYPE_TANK_MODEL12;\
   const int _base_##_MODEL_TANK13     = _base_##_BASE + TYPE_TANK_MODEL13;\
   const int _base_##_MODEL_TANK14     = _base_##_BASE + TYPE_TANK_MODEL14;
...
#define DEFINE_FE_TANK_WSET(start, _base_) \
   ...
   const int _base_##_MODEL_TANK13     = _base_##_BASE + TYPE_TANK_MODEL13;\
   const int _base_##_MODEL_TANK14     = _base_##_BASE + TYPE_TANK_MODEL14;\
   const int _base_##_WASTE_TANK_LEFT  = _base_##_BASE + TYPE_TANK_WASTE_LEFT;\
   const int _base_##_WASTE_TANK_RIGHT = _base_##_BASE + TYPE_TANK_WASTE_RIGHT;
...
#define DEFINE_FE_CHAMBER_SET(start, _base_) \
   ...
   const int _base_##_MODEL4    = _base_##_BASE + TYPE_CHAMBER_MODEL4;\
   const int _base_##_MODEL5    = _base_##_BASE + TYPE_CHAMBER_MODEL5;\
   const int _base_##_MODEL6    = _base_##_BASE + TYPE_CHAMBER_MODEL6;\
   const int _base_##_MODEL7    = _base_##_BASE + TYPE_CHAMBER_MODEL7;
...
#define DEFINE_FE_THERMISTORS_SET(start, _base_) \
   ...
   const int _base_##_M4        = _base_##_BASE + M4_CHAMBER_THERMISTOR;\
   const int _base_##_M5        = _base_##_BASE + M5_CHAMBER_THERMISTOR;\
   const int _base_##_M6        = _base_##_BASE + M6_CHAMBER_THERMISTOR;\
   const int _base_##_M7        = _base_##_BASE + M7_CHAMBER_THERMISTOR;\
   const int _base_##_SUPPORT_MODEL = _base_##_BASE + SUPPORT_MODEL_CHAMBER_THERMISTOR;\
   const int _base_##_M1_M2     = _base_##_BASE + M1_M2_CHAMBER_THERMISTOR;\
   const int _base_##_M3_M4     = _base_##_BASE + M1_M2_CHAMBER_THERMISTOR;\
   const int _base_##_M5_M6     = _base_##_BASE + M1_M2_CHAMBER_THERMISTOR;
...
#define DEFINE_ACTUATOR_SAME_VALUE(destID, srcID, descStr, formPartStr) const int FE_ACTUATOR_##destID = FE_CURRENT_ACTUATOR_STATUS_START + ACTUATOR_ID_##srcID;
...
const int FE_CURRENT_EVAC_AIRFLOW_IN_A2D        = 164;
const int FE_CURRENT_EVAC_AIRFLOW_SPEED         = 165;
const int FE_CURRENT_EVAC_AIRFLOW_STATUS        = 166;
...
const int FE_CTRL_SERVICE_KEY_DLG        = 7;
...
DEFINE_FE_THERMISTORS_SET (600, FE_CURRENT_HEAD_FILLING_IS_FILLED)
DEFINE_FE_TANK_WSET       (620, FE_CURRENT_TANK_STATUS)
DEFINE_FE_TANK_WSET       (640, FE_CURRENT_TANK_WEIGHT)
DEFINE_FE_TANK_WSET       (660, FE_CURRENT_TANK_RELATIVE_WEIGHT)
DEFINE_FE_TANK_WSET       (680, FE_TANK_EXISTENCE_STATUS)
DEFINE_FE_TANK_WSET       (700, FE_SET_ACTIVE_TANK)
DEFINE_FE_TANK_SET        (720, FE_UPDATE_RESIN_TYPE)
DEFINE_FE_CHAMBER_SET     (740, FE_SET_DRAIN_PUMPS)
DEFINE_FE_CHAMBER_SET     (760, FE_ACTIVE_PUMP)
DEFINE_FE_THERMISTORS_SET (780, FE_CURRENT_HEAD_FILLING)
DEFINE_FE_TANK_WSET       (800, FE_TANK_ENABLING_STATUS)
DEFINE_FE_TANK_SET        (820, FE_TANK_ID_NOTICE_DLG)
DEFINE_FE_TANK_WSET       (840, FE_TANK_DISABLING_HINT)
//Non Refreshable
//////////////////////////////////////////////////////
...
const int FE_CURRENT_MSC1_I2C_ANALOG_IN_24_STATUS  = 325;
const int FE_CURRENT_MSC1_I2C_ANALOG_IN_7_STATUS   = 326;
const int FE_CURRENT_MSC1_I2C_ANALOG_IN_5_STATUS   = 327;
const int FE_CURRENT_MSC1_I2C_ANALOG_IN_3_STATUS   = 328;
const int FE_CURRENT_MSC1_I2C_ANALOG_IN_24V_STATUS = 329;
const int FE_CURRENT_MSC1_I2C_ANALOG_IN_7V_STATUS  = 330;
const int FE_CURRENT_MSC1_I2C_ANALOG_IN_5V_STATUS  = 331;
const int FE_CURRENT_MSC1_I2C_ANALOG_IN_3V_STATUS  = 332;
const int FE_CURRENT_MSC2_I2C_ANALOG_IN_24_STATUS  = 333;
const int FE_CURRENT_MSC2_I2C_ANALOG_IN_7_STATUS   = 334;
const int FE_CURRENT_MSC2_I2C_ANALOG_IN_5_STATUS   = 335;
const int FE_CURRENT_MSC2_I2C_ANALOG_IN_3_STATUS   = 336;
const int FE_CURRENT_MSC2_I2C_ANALOG_IN_24V_STATUS = 337;
const int FE_CURRENT_MSC2_I2C_ANALOG_IN_7V_STATUS  = 338;
const int FE_CURRENT_MSC2_I2C_ANALOG_IN_5V_STATUS  = 339;
const int FE_CURRENT_MSC2_I2C_ANALOG_IN_3V_STATUS  = 340;
const int FE_CURRENT_MSC3_I2C_ANALOG_IN_24_STATUS  = 341;
const int FE_CURRENT_MSC3_I2C_ANALOG_IN_7_STATUS   = 342;
const int FE_CURRENT_MSC3_I2C_ANALOG_IN_5_STATUS   = 343;
const int FE_CURRENT_MSC3_I2C_ANALOG_IN_3_STATUS   = 344;
const int FE_CURRENT_MSC3_I2C_ANALOG_IN_24V_STATUS = 345;
const int FE_CURRENT_MSC3_I2C_ANALOG_IN_7V_STATUS  = 346;
const int FE_CURRENT_MSC3_I2C_ANALOG_IN_5V_STATUS  = 347;
const int FE_CURRENT_MSC3_I2C_ANALOG_IN_3V_STATUS  = 348;
const int FE_CURRENT_MSC4_I2C_ANALOG_IN_24_STATUS  = 349;
const int FE_CURRENT_MSC4_I2C_ANALOG_IN_7_STATUS   = 350;
const int FE_CURRENT_MSC4_I2C_ANALOG_IN_5_STATUS   = 351;
const int FE_CURRENT_MSC4_I2C_ANALOG_IN_3_STATUS   = 352;
const int FE_CURRENT_MSC4_I2C_ANALOG_IN_24V_STATUS = 353;
const int FE_CURRENT_MSC4_I2C_ANALOG_IN_7V_STATUS  = 354;
const int FE_CURRENT_MSC4_I2C_ANALOG_IN_5V_STATUS  = 355;
const int FE_CURRENT_MSC4_I2C_ANALOG_IN_3V_STATUS  = 356;
//Left room for another set of MSC

const int FE_CURRENT_PURGE_STATUS               = 365;
const int FE_CURRENT_X_AXIS_POSITION            = 366;
const int FE_CURRENT_Y_AXIS_POSITION            = 367;
const int FE_CURRENT_Z_AXIS_POSITION            = 368;
const int FE_CURRENT_T_AXIS_POSITION            = 369;

const int FE_HEAD_HEATERS_STATUS_BASE       = 370;
const int FE_HEAD_HEATERS_STATUS_HEAD_0     = FE_HEAD_HEATERS_STATUS_BASE; //=370
...
const int FE_HEAD_HEATERS_STATUS_BLOCK_3    = FE_HEAD_HEATERS_STATUS_BASE + BLOCK_3;//=381
//OBJET_MACHINE, PreHeater
//const int FE_HEAD_HEATERS_STATUS_PRE_HEATER = FE_HEAD_HEATERS_STATUS_BASE + PRE_HEATER;

const int FE_HEADS_OPERATION_MODE 				= 387;
const int FE_ERROR_IN_MOTOR                     = 388;
const int FE_CURRENT_VACUUM_LAST_VALUE          = 389;
const int FE_CURRENT_VACUUM_LAST_CMH2O_VALUE    = 390;
const int FE_SET_MACHINE_LOGO                   = 391;
const int FE_SET_DOOR_DLG_LABEL                 = 392;
const int FE_CURRENT_OCB_SENSOR_STATUS_START    = 393; //393 -425 (32 sensors)

const int FE_CURRENT_OHDB_3_3_V_POWER_SUPPLIERS_STATUS     = 430;
const int FE_CURRENT_OHDB_A2D_3_3_V_POWER_SUPPLIERS_STATUS = 431;
const int FE_CURRENT_OHDB_1_2_V_POWER_SUPPLIERS_STATUS     = 432;
const int FE_CURRENT_OHDB_A2D_1_2_V_POWER_SUPPLIERS_STATUS = 433;

const int FE_FANS_SPEED_BASE	   			= 440;
const int FE_FANS_LEFT_UV_FAN_1    			= FE_FANS_SPEED_BASE + LEFT_UV_FAN_1;
const int FE_FANS_LEFT_UV_FAN_2    			= FE_FANS_SPEED_BASE + LEFT_UV_FAN_2;
const int FE_FANS_LEFT_MATERIAL_FAN_1   	= FE_FANS_SPEED_BASE + LEFT_MATERIAL_FAN_1;
const int FE_FANS_LEFT_MATERIAL_FAN_2   	= FE_FANS_SPEED_BASE + LEFT_MATERIAL_FAN_2;
const int FE_FANS_LEFT_MATERIAL_FAN_3   	= FE_FANS_SPEED_BASE + LEFT_MATERIAL_FAN_3;
const int FE_FANS_RIGHT_UV_FAN_1        	= FE_FANS_SPEED_BASE + RIGHT_UV_FAN_1;
const int FE_FANS_RIGHT_UV_FAN_2        	= FE_FANS_SPEED_BASE + RIGHT_UV_FAN_2;
const int FE_FANS_RIGHT_MATERIAL_FAN_1  	= FE_FANS_SPEED_BASE + RIGHT_MATERIAL_FAN_1;
const int FE_FANS_RIGHT_MATERIAL_FAN_2  	= FE_FANS_SPEED_BASE + RIGHT_MATERIAL_FAN_2;
const int FE_FANS_MIDDLE_FAN            	= FE_FANS_SPEED_BASE + MIDDLE_FAN;
const int FE_FANS_MATERIAL_FANS_STATE   	= FE_FANS_SPEED_BASE + MATERIAL_FANS_STATE;
const int FE_FANS_MATERIAL_FANS_DUTY_CYCLE  = FE_FANS_SPEED_BASE + MATERIAL_FANS_DUTY_CYCLE;
