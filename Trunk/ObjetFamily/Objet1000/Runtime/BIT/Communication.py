...
#
# 	Version:	$Rev: 14165 $
# 	Date:		$Date: 2013-01-20 11:29:21 +0200 (Sun, 20 Jan 2013) $
# 	Path:		$HeadURL: http://srv-ire-svn/svn/ControlSW/Trunk/ObjetFamily/Base/PythonScripts/BIT/Communication.py $ 
#
################################################################################################
