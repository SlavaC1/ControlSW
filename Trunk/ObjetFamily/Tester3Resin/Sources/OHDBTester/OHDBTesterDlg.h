...
__published:	// IDE-managed Components
    ...
    TLabel *Label85;
    TLabeledEdit *V_3_3_PowerSupplyEdit;
    TLabeledEdit *V_1_2_PowerSupplyEdit;
    TEdit *V_3_3_PowerSupplyCEdit;
    TEdit *V_1_2_PowerSupplyCEdit;
    TLabel *Label46;
    TPanel *HardwareVersionPanel;
    TButton *GetHardwareVersionButton;
    TLabel *Label86;
    TPanel *ADVersionPanel;
    TButton *GetADVersionButton;
    TLabel *Label87;
    TGroupBox *EncoderGroupbox;
    TEdit *EncoderValueEdit;
    TButton *EncoderReadButton;
    ...
    void __fastcall GetADVersionButtonClick(TObject *Sender);
	void __fastcall EncoderReadButtonClick(TObject *Sender);
private:	// User declarations
    ...
    BYTE m_InternalA2DVersion;
    BYTE m_ExternalA2DVersion;
    ...
    WORD m_V_3_3_Voltage;
    WORD m_V_1_2_Voltage;
	...
	static void ReadEncoderDataReceiveHandler(int TransactionId, PVOID Data, unsigned DataLength, TGenericCockie Cockie);
