...
__published:	// IDE-managed Components
  ...
  TImageList *LEDsImageList;
	...
	TLabeledEdit *MSC1HWEdit;
	TLabeledEdit *MSC3FWEdit;
	TLabeledEdit *MSC1FWEdit;
	TLabeledEdit *MSC3HWEdit;
	TLabeledEdit *MSC2HWEdit;
	TLabeledEdit *MSC4HWEdit;
	TLabeledEdit *MSC2FWEdit;
	TLabeledEdit *MSC4FWEdit;
	TGroupBox *TanksExistenceGroupBox;
...
private:	// User declarations
  ...
  COCBDisplayThread *m_DisplayThread;
  ...
  BYTE    m_DoorStatus[MAX_NUM_OF_DOORS];
  ...
  BYTE    m_MSCHardwareVersion[NUM_OF_MSC_CARDS];
  BYTE    m_MSCFirmwareVersion[NUM_OF_MSC_CARDS];

  CQEvent m_LiquidTanksDisplayEvent;

  BYTE m_TankStatus[TOTAL_NUMBER_OF_CONTAINERS];

  CQEvent m_LiquidTanksWeightsDisplayEvent;
  float m_TankWeight[TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];  
  ...
  TLabeledEdit *m_TankInplaces[TOTAL_NUMBER_OF_CONTAINERS];
  TLabeledEdit *m_TankWeights [TOTAL_NUMBER_OF_CONTAINERS_INCLUDING_WASTE];
