...
rem import the old '~PerMachine_HM' parameters into the temp Q2RT.cfg
rem ------------------------------------------------------------------------------------------
start "" /wait ParamsExportAndImport.exe import ..\..\Backup\Modes\HighMixModes\~PerMachine_HM.cfg .\q2rt.cfg \Q
IF ERRORLEVEL 1 (GOTO ERROR_LABEL6)
IF NOT ERRORLEVEL 0 (GOTO ERROR_LABEL6)

rem Export from the temp Q2RT.cfg into the '~PerMachine_HM.cfg'
rem ----------------------------------------------------------------------------------
start "" /wait ParamsExportAndImport.exe export ..\..\Modes\HighMixModes\~PerMachine_HM.cfg .\q2rt.cfg \Q
...
rem --------------------------------------------------------- irrelevant in Objet 500
rem if exist "..\..\Backup\ServiceTools\SHR" md "..\..\ServiceTools\SHR"
rem copy "..\..\Backup\ServiceTools\SHR\Replaced Heads History.txt" "..\..\ServiceTools\SHR\Replaced Heads History.txt"
...
if exist "..\..\Backup\ServiceTools\Recent Maintenance Actions Performed" md "..\..\ServiceTools\Recent Maintenance Actions Performed"
copy "..\..\Backup\ServiceTools\Recent Maintenance Actions Performed\RecentActions.htm" "..\..\ServiceTools\Recent Maintenance Actions Performed\RecentActions.htm"
...
:ERROR_LABEL6
echo ***************************************************************************
echo Failed to import the old '~PerMachine_HM' parameters into the temp Q2RT.cfg
goto ERROR_END
:ERROR_LABEL7
echo ***************************************************************************
echo Failed to Export from the temp Q2RT.cfg into the '~PerMachine_HM.cfg
goto ERROR_END
:ERROR_END
