...
USEFORM("..\..\..\Base\FrontEnd\Windows\GeneralDialogs\PFFDlg.cpp", PFFJobForm);
...
USEFORM("..\..\..\Base\FrontEnd\Windows\GeneralDialogs\ServiceKeyDlg.cpp", ServiceKey);
USEFORM("..\..\..\Base\FrontEnd\Windows\GeneralDialogs\CustomRollerTiltWizardFrame.cpp", RollerTiltWizardFrame); /* TFrame: File Type */
USEFORM("..\..\..\Base\FrontEnd\Windows\GeneralDialogs\CustomZStartWizardFrame.cpp", CustomZStartWizardFrame); /* TFrame: File Type */
...
USEFORM("..\..\..\Base\FrontEnd\Windows\FansSpeedDlg.cpp", FansSpeedDlg);
...
WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR CmdLineParam, int)
{
		...
		Application->CreateForm(__classid(TServiceKey), &ServiceKey);
		Application->CreateForm(__classid(TFansSpeedDlg), &FansSpeedDlg);
		Application->CreateForm(__classid(TPFFJobForm), &PFFJobForm);
		Application->Run();
          }
