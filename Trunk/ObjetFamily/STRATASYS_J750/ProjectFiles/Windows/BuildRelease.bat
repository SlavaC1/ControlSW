...
@msbuild STRATASYS_J750.cbproj /t:clean;build /p:config="Emulation" 

@pushd .
@cd ..\..\Runtime
@copy STRATASYS_J750.exe STRATASYS_J750_emulation.exe /Y
@del STRATASYS_J750.exe
@popd

@msbuild STRATASYS_J750.cbproj /t:clean;build /p:config="Release Build" 
