...
#
# 	Version:	$Rev: 11331 $
# 	Date:		$Date: 2012-03-26 14:27:28 +0200 (Mon, 26 Mar 2012) $
# 	Path:		$HeadURL: http://srv-ire-svn/svn/ControlSW/Branches/Slava/RaccoonForObjet260Release/ObjetFamily/Base/PythonScripts/BIT/Encoder.py $ 
#
################################################################################################
