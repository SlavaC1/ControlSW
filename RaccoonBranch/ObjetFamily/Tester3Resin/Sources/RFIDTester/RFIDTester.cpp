...
void TRFIDForm::Open()
{
  ...
  {
    QMonitor.ErrorMessage("Unable to initialize RFID. Check that Reader is connected to ComPort 3");
  }
  ...
  m_Channel = 0;
  m_rdrNum = 0;
  m_TagAccess[RFRDR1] = new CContainerTag(RFRDR1, m_Channel);
  m_TagAccess[RFRDR2] = new CContainerTag(RFRDR2, m_Channel);
