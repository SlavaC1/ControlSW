...
# 	Path:		$HeadURL: http://srv-ire-svn/svn/ControlSW/Branches/Slava/RaccoonForObjet260Release/ObjetFamily/Base/PythonScripts/BIT/Motors.py $ 
#
################################################################################################
...
Z_MOVE_TO_LIMIT_TIMEOUT = 30000 # 30 Seconds
...
class LimitsTest(SingleTest):
  ...
  def LimitTest(Self,Axis,Pos,CheckLimitFunc):
    ...
    if Timeout:
      Self.SetActualVsRequested('','',"Can not find Limit switch at position:" + str(int(Pos) - AxisPositionModifier))
      return False
