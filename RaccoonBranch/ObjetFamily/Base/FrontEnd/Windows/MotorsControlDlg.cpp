...
{
  bool LeftLimitStatus = false;
  bool RightLimitStatus = false;
  ...
  LeftLimitStatus =  BackEnd->MotorGetAxisLeftLimit(Axis);
  RightLimitStatus = BackEnd->MotorGetAxisRightLimit(Axis);
