object MainForm: TMainForm
  ...
  inline MainUIFrame: TMainUIFrame
    ...
    inherited ScreensPlaceHolder: TPanel
      ...
      inherited MainMenuFrame: TMainMenuFrame
        inherited Panel1: TPanel
          inherited DateLabel: TLabel
            Margins.Bottom = 0
          end
  ...
  object ActionList1: TActionList
    ...
    object ShowTroubleshootingAction: TAction
      Category = 'Help Activities'
      Caption = 'Troubleshooting'
      OnExecute = ShowTroubleshootingActionExecute
    end
  ...
  object MaintenancePopupMenu: TPopupMenu
    ...
    object WizardsMenuItem: TMenuItem
      ...
      object TrayPointsCalibrationItem: TMenuItem
        Action = MainUIFrame.OpenTrayPointsWizardAction
        Caption = 'Tray Calibration'
      end
      object VacuumSensorCalibrationItem: TMenuItem
        Action = MainUIFrame.VacuumCalibrationAction
      end
      object UVCalibrationWizardItem: TMenuItem
        Action = MainUIFrame.UVCalibrationWizard
        Caption = 'UV Calibration (EXT)'
        Visible = False
      end
      object UVMCalibrationWizardItem: TMenuItem
        Action = MainUIFrame.UVMCalibrationWizard
        Caption = 'UV Calibration (UVM)'
        Visible = False
      end
  ...
  object HelpPopupMenu: TPopupMenu
    ...
    object Troubleshooting1: TMenuItem
      Action = ShowTroubleshootingAction
    end
