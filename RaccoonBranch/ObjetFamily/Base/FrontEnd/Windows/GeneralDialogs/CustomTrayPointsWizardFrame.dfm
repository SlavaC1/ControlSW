object TrayPointsWizardFrame: TTrayPointsWizardFrame
  ...
  object SubTitleLine1Label: TLabel
    ...
    Height = 17
    AutoSize = False
    Caption = 'Use the arrows to lower the build tray. Then remove the right'
  ...
  object SubTitleLine2Label: TLabel
    ...
    Width = 158
    Height = 13
    Caption = 'UV lamp and attach the indicator.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'MS Sans Serif'
  ...
  object IndicatorInPlaceCheckBox: TCheckBox
    ...
    Width = 297
    Height = 17
    Caption = 'The indicator is attached and touching the tray.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -12
    Font.Name = 'MS Sans Serif'
