...
void THeadsButtonsEntryFrame::DoMissingNozzlesSanityCheck(TMultiGridEdit* Edit)
{
  ...
  if(MissingNozzles > NOZZLES_IN_HEAD)
  	throw EOverMaxExist(QFormatStr(LOAD_STRING(IDS_ENTERED_NOZZLES_OVER_MAX_EXIST),MissingNozzles, NOZZLES_IN_HEAD));
