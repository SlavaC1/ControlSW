...
class CResinReplacementNewWizard;
...
private: //Variables
    ...
    // Wizards
    CResinReplacementNewWizard*          m_ResinReplacementNewWizard;
    ...
    CShutdownWizard*	 				 m_ShutdownWizard;
...
private: //Methods
    ...
    void UpdatePrintTime                          (TDateTime CurrentTime);
