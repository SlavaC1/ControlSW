...
{
  ResetButtons[PATTERN_TEST_COUNTER_ID]->Visible = false;
  ResetButtons[HS_TIME_SINCE_LAST_HOW_COUNTER_ID]->Visible = false;
  ResetButtons[HQ_TIME_SINCE_LAST_HOW_COUNTER_ID]->Visible = false;
  ResetButtons[DM_TIME_SINCE_LAST_HOW_COUNTER_ID]->Visible = false;
  ResetButtons[UV_LAMPS_CALIBRATION_COUNTER_ID]->Visible = false;
  ResetButtons[LAST_HCW_ACTIVATION_TIME_COUNTER_ID]->Visible = false;
  ResetButtons[HEAD_ALIGNMENT_COUNTER_ID]->Visible = false;
  ResetButtons[LOAD_CELL_CALIBRATION_COUNTER_ID]->Visible = false;
  ResetButtons[WIPER_CLEANING_COUNTER_ID]->Visible = false;
  ResetButtons[SERVICE_COUNTER_ID]->Visible = false;
