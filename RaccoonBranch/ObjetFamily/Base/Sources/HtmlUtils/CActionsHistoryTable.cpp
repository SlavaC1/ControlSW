...
int CActionHistoryData::GetCurrentDateIndex()
{
...
QString CActionHistoryData::GetCurrentDate()
{
...
void CActionsHistoryTable::Init()
{
  ...
  m_ActionIndexMap[WIZARD_TITLE(IDS_UVC_WIZARD)] = actionIndex++;
  m_ActionIndexMap[WIZARD_TITLE(IDS_UVR_WIZARD)] = actionIndex++;
  m_ActionIndexMap[WIZARD_TITLE(IDS_XO_WIZARD)] = actionIndex++;
  m_ActionIndexMap[WIZARD_TITLE(IDS_HEAD_SERVICE_WIZARD)] = actionIndex++;
  ...
  m_ActionIndexMap["Transparency HQ"] = actionIndex++;
