...
public:
  ...
  QString GetBatchNo(int index);
  QString GetLastBatchNo();
  ...
  QString GetResinType();
  int GetBatchNoIndex() { return m_nextBatchNoIndex; }
...
public:
  ...
  void DeInit();
  QString GetPrintStart() { return m_printStart; }
  QString GetPrintEnd() { return m_printEnd; }
  QString GetTrayID() { return m_trayID; }
  QString GetPrintingMode() { return m_printingMode; }
