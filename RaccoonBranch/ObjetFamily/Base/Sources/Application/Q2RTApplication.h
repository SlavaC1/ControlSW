...
class CQ2RTApplication : public CQApplication
{
  private:
	...
	static QString LogFileChangeEventHandler(const QString& NewLogFileName,TGenericCockie Cockie);
	static QString GetTagDictionary();
	...
	bool m_SupportReplacementAllowed; 
  ...
  public:
    ...
    void ExecFileSafe(QString FileName,bool ClearDictionary = true);
	void SetQATestsAllowed(bool allowed);
	void SetSupportReplacementAllowed(bool allowed);
	bool GetQATestsAllowed();
	bool GetSupportReplacementAllowed(); 
