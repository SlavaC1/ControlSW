...
public:
  ...
  int operator + (const CTemperature& T2)  { return (m_A2DValue - T2.m_A2DValue);}
  int operator - (const CTemperature& T2)  { return (m_A2DValue + T2.m_A2DValue);}

  bool operator == (const CTemperature& T2) {
...
public:
  ...
  bool operator == (const CProportionalTemperature& T2) {
    return (m_A2DValue == T2.m_A2DValue);
  }
...
public:
  ...
  bool operator == (const CSelfTemperature& T2) {
    return (m_A2DValue == T2.m_A2DValue);
  }
