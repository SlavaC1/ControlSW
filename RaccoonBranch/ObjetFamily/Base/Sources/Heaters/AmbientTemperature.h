...
class CAmbientTemperatureBase : public CQComponent {
  ...
  public:
   // Constructor
    ...
    //This procedure get the value of Current ambient temporature
    DEFINE_METHOD(CAmbientTemperatureBase,int,GetCurrentTemperatureCelcius);

    //This procedure get the value of Current ambient temporature in A/D units
    ...
    //This procedure check if temperature is in range
