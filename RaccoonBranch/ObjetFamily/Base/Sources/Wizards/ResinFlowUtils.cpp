...
{
   return (0 == _pumpControllerPointersVector.size());
}
...
TChamberIndex ResinFlowUtils::chamberIndexByPumpIndex(TPumpIndex pump)// todo 3 -oArcady.Volman@objet.com -cNone: Add ifdefs for other machines
{
	...
	{
#ifdef OBJET_MACHINE
	case MODEL1_H0_1_PUMP:
	case MODEL2_H0_1_PUMP:
		return TYPE_CHAMBER_MODEL1;
	case MODEL3_H2_3_PUMP:
	case MODEL4_H2_3_PUMP:
        //case MODEL1_2_H2_3_PUMP:
		return TYPE_CHAMBER_MODEL2;
        case MODEL5_H4_5_PUMP:
	case MODEL6_H4_5_PUMP:
        //case SUPPORT_PUMP_H4_5_PUMP:
		return TYPE_CHAMBER_MODEL3;
#else		
	case MODEL2_H0_1_PUMP:
	case MODEL1_H0_1_PUMP:
		return TYPE_CHAMBER_MODEL1;
	case MODEL2_H2_3_PUMP:
	case MODEL1_H2_3_PUMP:
		return TYPE_CHAMBER_MODEL2;
#endif
	case SUPPORT_PUMP1:
	case SUPPORT_PUMP2:
...
ResinFlowUtils::TPumpIndicesVector ResinFlowUtils::pumpIndicesByTankIndex(TTankIndex tank)
{
    ...
    case TYPE_TANK_MODEL1:
		...
		v.push_back(MODEL2_H2_3_PUMP);
		v.push_back(MODEL2_H0_1_PUMP);
    #elif defined OBJET_MACHINE
    	v.push_back(MODEL1_H0_1_PUMP);
	#else
		v.push_back(MODEL_PUMP_2);
	#endif
		break;
	...
	#ifdef CONNEX_MACHINE
		v.push_back(MODEL1_H2_3_PUMP);
		v.push_back(MODEL1_H0_1_PUMP);
	#elif defined OBJET_MACHINE
    	v.push_back(MODEL2_H0_1_PUMP);        
        #else
		v.push_back(MODEL_PUMP_1);
	#endif
		break;
#endif                
#ifdef OBJET_MACHINE
    case TYPE_TANK_MODEL3:
		v.push_back(MODEL3_H2_3_PUMP);
                break;
    case TYPE_TANK_MODEL4:
		v.push_back(MODEL4_H2_3_PUMP);
                break;
	case TYPE_TANK_MODEL5:
		v.push_back(MODEL5_H4_5_PUMP);
                break;
	case TYPE_TANK_MODEL6:
		v.push_back(MODEL6_H4_5_PUMP);
                break;								
#endif
	}
	return v;
