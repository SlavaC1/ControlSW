...
const int LOG_TAG_HASP         = 14;
const int LOG_TAG_ROLLER_SUCTION_SYSTEM    = 15; /*RSS, itamar*/
const int LOG_TAG_OBJET_MACHINE = 16;
const int LOG_TAG_RACCOON       = 17;
const int LOG_TAG_SERVICE	    = 18;
const int LAST_LOG_TAG          = 19;
