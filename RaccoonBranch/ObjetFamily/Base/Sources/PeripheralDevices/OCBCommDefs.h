...
//const int GET_VACUUM_PUMP_VOLTAGE_VALUE      = 0xA0; //Elad,not in use
const int GET_POWER_SUPPLIES_VALUE   		 = 0xA1; //Elad
...
const int OCB_LIQUID_TANK_STATUS_CHANGED        = 0xE9; // Not needed with Raccoon
...
const int OCB_VACUUM_PUMP_VOLTAGE_VALUE         = 0xF6; //Elad
const int OCB_POWER_SUPPLIES_VALUE              = 0xF7; //Elad
const int OCB_MSC_STATUS_NOTIFICATION           = 0xF8; //Elad
const int OCB_I2C_DEBUG_NOTIFICATION            = 0xF9; //Elad
//=================================================================
...
struct TOCBGetPowerSuppliesStatusResponse{  //Elad
    ...
    USHORT V_12Volt;
	USHORT V_24Volt;
	USHORT FirstI2CA2DInput[4];
	USHORT SecondI2CA2DInput[4];
	}STRUCT_ATTRIBUTE; 
...
struct TOCBUvLampValueResponse {
  BYTE   MessageID;
  USHORT NumOfActualReadings;
  USHORT ValueEXT;
  USHORT NumOfSaturatedReadings;
  USHORT MaxValueEXT;
  USHORT SaturationFlag;
  USHORT MaxDeltaEXT;
  ULONG  SumINT;
  ULONG  SumEXT;
