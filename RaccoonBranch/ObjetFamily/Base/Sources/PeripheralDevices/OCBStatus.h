...
class COCBStatusSender : public CQThread {
   private:
     ...
     int m_MSC1_HW_Version;
	 int m_MSC1_FW_Version;
	 int m_MSC2_HW_Version;
	 int m_MSC2_FW_Version;
   ...
   int GetMSC1HWVersion(void);
   int GetMSC1FWVersion(void);
   int GetMSC2HWVersion(void);
   int GetMSC2FWVersion(void);
