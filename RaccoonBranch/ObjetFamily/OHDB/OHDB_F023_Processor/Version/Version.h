...
#define INTERNAL_SOFTWARE_VERSION			51


// Version 10.51
/*
1. Replaced RESET_ALL command to print driver during FireAll (PrintDrv_FireAllTask) with a reset to State Machine.
*/

// Version 10.5
/*
1. Change Head voltage initlization
2. "TSetPrintingHeadsParamsMsg" struct was changed.
3. This version also included application changes/ and FPGA changes   
*/
// Version 10.41
/*
