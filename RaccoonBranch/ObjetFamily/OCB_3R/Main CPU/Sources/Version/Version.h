...
#define EXTERNAL_SOFTWARE_VERSION			21
#define INTERNAL_SOFTWARE_VERSION			00

/* 
ChangeLog

ver 21.00
1. Added the ability to change A2D Task Delay at runtime using SET_UV_SAMPLING_PARAMS_EX
...
3. Removed Internal UV mechanism - not used in proffesional
...
ver 20.96
1. ISRKeepAliveCheck changed to 100 cycles.
2. ON_OFF_DELAY changed to 250.
