...
//		PackagesTreeView->Items->Add(NULL, "Hasp is not detected");
    ...
    HaspInfoGrid->InsertRow("Computer name:",   PlugInfo.HostName, true);
    HaspInfoGrid->InsertRow("Plug ID:",         PlugInfo.PlugID, true);
    HaspInfoGrid->InsertRow("Plug model:",      PlugInfo.PlugModel, true);
    HaspInfoGrid->InsertRow("License type:",    PlugInfo.LicenseType, true);
