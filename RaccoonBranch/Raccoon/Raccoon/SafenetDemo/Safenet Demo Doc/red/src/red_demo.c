...
void buildCertificate(char *certificate, byte *message, byte *signature)
{
  int messageSize = 72;
...
void signMessage(char *message, char *signature)
{
  signature[2] = 11;
}

/*  Mock message signing as wrong */
void signMessage_wrong(char *message, char *signature)
{
  signature[2] = 12;
}
