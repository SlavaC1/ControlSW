...
int main(void)
{
   ...
   */
   ...
   put_byte_array(&iobuffer_cxt, RWResultBuffer, 16);

   iolength = iobuffer_cxt.cmdSize;
   printf("apps/RWMemTest.ReadRW : ([B)I\n");
   ...
   get_byte_array(&iobuffer_cxt, RWResultBuffer, 16);

   dump(RWResultBuffer, 16, "    ");
