...
void put_bool(PVM_IO_BUFFER_T piobuffer, boolean data) {
   if (data == TRUE)  {
...
void put_bool_array(PVM_IO_BUFFER_T piobuffer, boolean* data, hasp_u8_t length) {
...
boolean get_boolean(PVM_IO_BUFFER_T piobuffer) {
   return piobuffer->rspBuff[piobuffer->rspOff++] != 0;
}
...
hasp_s32_t get_boolean_array(PVM_IO_BUFFER_T piobuffer, boolean* data, hasp_u8_t length) {
   hasp_s32_t i;
