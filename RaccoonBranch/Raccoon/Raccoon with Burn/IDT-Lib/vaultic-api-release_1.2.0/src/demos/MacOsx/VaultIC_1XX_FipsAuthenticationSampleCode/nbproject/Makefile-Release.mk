...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_1xx_fipsauthenticationsamplecode: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_1xx_fipsauthenticationsamplecode ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/_ext/1329223797/vaultic_1XX_fips_authentication_sample_code.o: ../../common/vaultic_1XX_fips_authentication_sample_code.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -D_MACOS -I../../../common -I../../../arch/pc/shared -I../../../device/vaultic_1XX_family -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1329223797/vaultic_1XX_fips_authentication_sample_code.o ../../common/vaultic_1XX_fips_authentication_sample_code.cpp
