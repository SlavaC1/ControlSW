...
LDLIBSOPTIONS=-ldl -lpthread-2.15
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_4xx_sample: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_4xx_sample ${OBJECTFILES} ${LDLIBSOPTIONS} -ldl

${OBJECTDIR}/_ext/1329223797/vaultic_4XX_sample_code.o: ../../common/vaultic_4XX_sample_code.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1329223797
	${RM} $@.d
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX -I../../../common -I../../../arch/pc/shared -I../../../device/vaultic_4XX_family -I/usr/include/PCSC -I/usr/local/include/PCSC -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1329223797/vaultic_4XX_sample_code.o ../../common/vaultic_4XX_sample_code.cpp
