...
${OBJECTDIR}/_ext/1329223797/vaultic_4XX_key_derivation_sample.o: ../../common/vaultic_4XX_key_derivation_sample.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_LINUX -I../../../common -I../../../arch/pc/shared -I../../../device/vaultic_4XX_family -I/usr/include/PCSC -I/usr/local/include/PCSC -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1329223797/vaultic_4XX_key_derivation_sample.o ../../common/vaultic_4XX_key_derivation_sample.cpp
