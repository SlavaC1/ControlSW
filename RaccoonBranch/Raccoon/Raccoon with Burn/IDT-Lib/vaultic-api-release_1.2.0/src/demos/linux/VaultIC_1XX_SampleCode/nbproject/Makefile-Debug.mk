...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_1xx_samplecode: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_1xx_samplecode ${OBJECTFILES} ${LDLIBSOPTIONS} -ldl

${OBJECTDIR}/_ext/1329223797/vaultic_1XX_sample_code.o: ../../common/vaultic_1XX_sample_code.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1329223797
	${RM} $@.d
	$(COMPILE.cc) -g -D_DEBUG -D_LINUX -I../../../common -I../../../arch/pc/shared -I../../../device/vaultic_1XX_family -I/usr/local/include/PCSC -I/usr/include/PCSC -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1329223797/vaultic_1XX_sample_code.o ../../common/vaultic_1XX_sample_code.cpp
