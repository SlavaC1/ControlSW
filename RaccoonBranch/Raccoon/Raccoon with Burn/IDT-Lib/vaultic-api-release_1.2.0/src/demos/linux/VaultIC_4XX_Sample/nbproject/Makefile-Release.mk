...
${OBJECTDIR}/_ext/1329223797/vaultic_4XX_sample_code.o: ../../common/vaultic_4XX_sample_code.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -D_LINUX -I../../../common -I../../../arch/pc/shared -I../../../device/vaultic_4XX_family -I/usr/local/include/PCSC -I/usr/include/PCSC -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1329223797/vaultic_4XX_sample_code.o ../../common/vaultic_4XX_sample_code.cpp
