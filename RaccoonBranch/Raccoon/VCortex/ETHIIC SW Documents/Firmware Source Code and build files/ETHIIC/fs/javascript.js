...
function boardNameSet()
{
    var req = false;
    var name_txt = document.getElementById("boardName");
    ...
    if(req)
    {
        req.open("GET", "/cgi-bin/set_speed?percent=" + name_txt.value +
                        "&id" + Math.random(), true);
        req.onreadystatechange = nameComplete;
        req.send(null);
    }
}
