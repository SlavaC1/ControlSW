...
LDLIBSOPTIONS=../../../build/linux/VaultIC_API_1XX/dist/GNU-Linux-x86/Debug_Static/libvaultic_api_1xx.a -lpcsclite

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_1xx_samplecode

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_1xx_samplecode: ../../../build/linux/VaultIC_API_1XX/dist/GNU-Linux-x86/Debug_Static/libvaultic_api_1xx.a
...
${OBJECTDIR}/_ext/1329223797/vaultic_1XX_sample_code.o: ../../common/vaultic_1XX_sample_code.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DUSE_STATIC_API -D_DEBUG -D_LINUX -I../../../common -I../../../arch/pc/shared -I../../../device/vaultic_1XX_family -I/usr/local/include/PCSC -I/usr/include/PCSC -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1329223797/vaultic_1XX_sample_code.o ../../common/vaultic_1XX_sample_code.cpp
