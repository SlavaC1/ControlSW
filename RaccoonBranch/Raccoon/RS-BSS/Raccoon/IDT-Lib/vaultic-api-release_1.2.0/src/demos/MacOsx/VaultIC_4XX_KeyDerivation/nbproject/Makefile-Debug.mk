...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_4XX_keyderivation: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/vaultic_4XX_keyderivation ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/_ext/1329223797/vaultic_4XX_key_derivation_sample.o: ../../common/vaultic_4XX_key_derivation_sample.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -D_DEBUG -D_MACOS -DVAULTIC_4XX_FIPS -I../../../common -I../../../arch/pc/shared -I../../../device/vaultic_4XX_family -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1329223797/vaultic_4XX_key_derivation_sample.o ../../common/vaultic_4XX_key_derivation_sample.cpp
