...
#   define RSSIM_LIB
	...
	public:
		...
		///
		virtual int BurnIDC(unsigned char ucCartridgeNum, const unsigned char *aucMaterialInfo, unsigned short usMaterialInfoLength, unsigned char* aucCertificate, unsigned short* usCertificateLength);
#endif
		///
...
#if (ENABLE_BURNING == 1)
		int GetBurnIDCBehavior(unsigned char ucCartridgeNum, const unsigned char *aucMaterialInfo, unsigned short usMaterialInfoLength);
#endif
